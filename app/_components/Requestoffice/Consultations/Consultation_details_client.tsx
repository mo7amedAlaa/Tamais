...
import { getListReservedFromClient_Client } from "@/app/_api/queries/office.query";
...
const Consultation_details_client: React.FC<PropsIN> = ({ consultID }) => {
...
export default Consultation_details_client;
