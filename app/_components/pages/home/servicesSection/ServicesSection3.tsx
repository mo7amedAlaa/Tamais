    ...
    <div className="flex flex-col gap-[20px]">
      ...
      <div className=" grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[25px]">
        <GoldCard>
          ...
          >
            <Image src={"/Icons/justice.svg"} width={22} height={22} alt="" />
          </div>
          <h1 className=" font-medium text-[18px]">نظام القضايا</h1>
          {/* <ParagraphTextExample /> */}
        </GoldCard>
        <Card>
          <div className=" text-gold rounded-full p-[20px] bg-white shadow-md">
            <Image src={"/Icons/message.svg"} width={22} height={22} alt="" />
          </div>
          <h1 className=" font-medium text-[18px]">نظام المراسلات</h1>
          {/* <ParagraphTextExample /> */}
        </Card>
        <Card>
          <div className=" text-gold rounded-full p-[20px] bg-white shadow-md">
          ...
          <h1 className=" font-medium text-[18px]">الموارد البشرية</h1>
          {/* <ParagraphTextExample /> */}
        </Card>
        <Card>
          <div className=" text-gold rounded-full p-[20px] bg-white shadow-md">
            <Image src={"/Icons/Laptop.png"} width={22} height={22} alt="" />
          </div>
          <h1 className=" font-medium text-[18px]">منصة التدريب </h1>
          {/* <ParagraphTextExample /> */}
        </Card>
      </div>
    </div>
