'use client';
import { replyToServiceFromClient } from "@/app/_api/queries/office.query";
...
const ServiceReplyAndDetails: React.FC<PropsIN> = ({ servID }) => {
...
export default ServiceReplyAndDetails;
