...
function Page() {
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-[25px] gap-y-4  justify-center py-3 md:py-6">
      <CustomizationCard title={'نوكيل محامي'} active={true} price1={'300'} price2={'500'} price3={'600'} />
      <CustomizationCard title={'نوكيل محامي'} active={false} price1={'300'} price2={'500'} price3={'600'} />
      <CustomizationCard title={'نوكيل محامي'} active={true} price1={'300'} price2={'500'} price3={'600'} />
      <CustomizationCard title={'نوكيل محامي'} active={true} price1={'300'} price2={'500'} price3={'600'} />
      <CustomizationCard title={'نوكيل محامي'} active={false} price1={'300'} price2={'500'} price3={'600'} />
      <CustomizationCard title={'نوكيل محامي'} active={true} price1={'300'} price2={'500'} price3={'600'} />
